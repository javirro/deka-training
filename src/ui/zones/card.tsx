...
const DekaZoneCard = ({ zone }: { zone: DekaZone }) => {
  return (
    <div className="w-full sm:w-[30%] sm:h-[240px] flex flex-col border border-red-950 rounded-lg p-4 shadow-md bg-transparent/20 hover:shadow-lg transition-shadow">
